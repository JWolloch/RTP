...
In the robust optimization framework, an \textit{uncertain-LP} is defined as a collection:
      ...
      \]
Under this paradigm, we do not persume to know the data's distribution, only the range of possible values.
...
\begin{frame}{What's Uncertain?}
    ...
    \]
    \begin{enumerate}
        \item $\mathbf{D}_{v,i}$ is the influence the $i$-th beamlet has on the voxel $v$.
        \item The impact of the \textit{physical dose} depends on biological factors.
    \end{enumerate}
